...
/* loaded from: picacg_1.jar:retrofit2/ExecutorCallAdapterFactory.class */
public final class ExecutorCallAdapterFactory extends CallAdapter.Factory {
    final Executor callbackExecutor;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:retrofit2/ExecutorCallAdapterFactory$ExecutorCallbackCall.class */
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        @Override // retrofit2.Call
        public Call<T> clone() {
            return new ExecutorCallbackCall(this.callbackExecutor, this.delegate.mo574clone());
        }
