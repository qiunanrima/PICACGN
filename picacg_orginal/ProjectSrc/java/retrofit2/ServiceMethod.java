...
/* loaded from: picacg_1.jar:retrofit2/ServiceMethod.class */
public final class ServiceMethod<R, T> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:retrofit2/ServiceMethod$Builder.class */
            ...
            if (annotation instanceof Url) {
                ...
                if (value5.isEmpty()) {
                    if (!Iterable.class.isAssignableFrom(rawType9)) {
                        ...
                        } else if (MultipartBody.Part.class.isAssignableFrom(rawType9)) {
