...
/* loaded from: picacg_1.jar:okhttp3/internal/http2/Http2.class */
public final class Http2 {
    ...
    public static String frameLog(boolean z, int i, int i2, byte b, byte b2) {
        return Util.format("%s 0x%08x %5d %-13s %s", z ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), b < FRAME_NAMES.length ? FRAME_NAMES[b] : Util.format("0x%02x", Byte.valueOf(b)), formatFlags(b, b2));
    }
