...
/* loaded from: picacg_1.jar:com/google/gson/internal/$Gson$Types.class */
public final class C$Gson$Types {
    static final Type[] EMPTY_TYPE_ARRAY = new Type[0];

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.google.gson.internal.$Gson$Types$GenericArrayTypeImpl */
    /* loaded from: picacg_1.jar:com/google/gson/internal/$Gson$Types$GenericArrayTypeImpl.class */
    ...
    /* loaded from: picacg_1.jar:com/google/gson/internal/$Gson$Types$ParameterizedTypeImpl.class */
    ...
    /* loaded from: picacg_1.jar:com/google/gson/internal/$Gson$Types$WildcardTypeImpl.class */
    ...
    /* JADX WARN: Type inference failed for: r0v23, types: [com.google.gson.internal.$Gson$Types$GenericArrayTypeImpl] */
    public static Type canonicalize(Type type) {
        if (type instanceof Class) {
            Class cls = (Class) type;
            Class cls2 = cls;
            if (cls.isArray()) {
                cls2 = new GenericArrayTypeImpl(canonicalize(cls.getComponentType()));
            }
            return cls2;
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (z) {
            parameterizedType2 = newParameterizedTypeWithOwner(resolve5, parameterizedType.getRawType(), actualTypeArguments);
        }
