...
/* loaded from: picacg_1.jar:com/google/gson/internal/bind/JsonTreeReader.class */
public final class JsonTreeReader extends JsonReader {
    ...
    public String getPath() {
        ...
        while (true) {
            ...
            if (this.stack[i3] instanceof JsonArray) {
                int i4 = i3 + 1;
                i = i4;
                if (this.stack[i4] instanceof Iterator) {
                    sb.append('[');
                ...
                i = i3;
                if (this.stack[i3] instanceof JsonObject) {
                    int i5 = i3 + 1;
                    i = i5;
                    if (this.stack[i5] instanceof Iterator) {
                        sb.append('.');
                        i = i5;
                        if (this.pathNames[i5] != null) {
                            sb.append(this.pathNames[i5]);
                            i = i5;
                        }
                    }
                }
