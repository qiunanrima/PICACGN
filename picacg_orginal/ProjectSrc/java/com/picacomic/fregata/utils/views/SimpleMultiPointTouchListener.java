...
/* loaded from: picacg_1.jar:com/picacomic/fregata/utils/views/SimpleMultiPointTouchListener.class */
public class SimpleMultiPointTouchListener implements View.OnTouchListener {
    ...
    public void setFillWidth(ImageView imageView) {
        ...
        float height = ((float) imageView.getHeight()) / 2.0f;
        float intrinsicHeight = ((float) imageView.getDrawable().getIntrinsicHeight()) / 2.0f;
        ...
        sb.append(height - (intrinsicHeight * width));
        printLog("MultiPointTouchListener", sb.toString());
        this.matrix.setScale(width, width);
