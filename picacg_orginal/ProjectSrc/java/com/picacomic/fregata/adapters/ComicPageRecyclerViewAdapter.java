...
/* loaded from: picacg_1.jar:com/picacomic/fregata/adapters/ComicPageRecyclerViewAdapter.class */
public class ComicPageRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder instanceof AdvertisementListViewHolder) {
            ...
            if (this.jv) {
                Picasso.with(this.context).load(b).placeholder(2131231029).into(((ComicPageViewHolder) viewHolder).imageView_image);
            } else {
                Picasso.with(this.context).load(b).placeholder(2131231028).into(((ComicPageViewHolder) viewHolder).imageView_image);
            }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return i != 2 ? new ComicPageViewHolder(this.mLayoutInflater.inflate(2131427463, viewGroup, false)) : new AdvertisementListViewHolder(this.mLayoutInflater.inflate(2131427440, viewGroup, false));
    }
