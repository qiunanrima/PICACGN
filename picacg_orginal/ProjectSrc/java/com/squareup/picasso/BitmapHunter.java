...
/* loaded from: picacg_1.jar:com/squareup/picasso/BitmapHunter.class */
public class BitmapHunter implements Runnable {
    ...
    private Picasso.Priority computeNewPriority() {
        ...
        boolean z = (this.actions == null || this.actions.isEmpty()) ? false : true;
        boolean z2 = true;
        if (this.action == null) {
            z2 = z;
        }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x001f, code lost:
        if (r3.actions.isEmpty() != false) goto L7;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00f6, code lost:
        if (r5.exifRotation != 0) goto L35;
     */
    /* JADX WARN: Code restructure failed: missing block: B:42:0x0111, code lost:
        if (r5.exifRotation != 0) goto L60;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
