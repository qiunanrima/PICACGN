...
/* loaded from: picacg_1.jar:android/support/design/widget/HeaderScrollingViewBehavior.class */
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        if (this.mOverlayTop != 0) {
            i = MathUtils.clamp((int) (getOverlapRatioForOffset(view) * this.mOverlayTop), 0, this.mOverlayTop);
        }
        return i;
    }
