...
/* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout.class */
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$Behavior.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$DefaultBehavior.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$DispatchChangeEvent.class */
    public @interface DispatchChangeEvent {
    }

    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$HierarchyChangeListener.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$LayoutParams.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$OnPreDrawListener.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$SavedState.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CoordinatorLayout$ViewElevationComparator.class */
    ...
    static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            if (constructor == null) {
                constructor2 = Class.forName(str2, true, context.getClassLoader()).getConstructor(CONSTRUCTOR_PARAMS);
        ...
        while (true) {
            ...
            if (i2 < size) {
                ...
                if ((z4 || z5) && actionMasked != 0) {
                    ...
                    boolean z6 = isBlockingInteractionBelow && !didBlockInteraction;
                    z2 = z;
                    z3 = z6;
                    motionEvent2 = motionEvent3;
        ...
        for (int i7 = 0; i7 < size3; i7++) {
            ...
            if (view.getVisibility() != 8) {
                ...
                if (layoutParams.keyline >= 0 && mode != 0) {
                    ...
                    suggestedMinimumHeight = Math.max(i8, paddingTop + paddingBottom + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                ...
                onMeasureChild(view, i4, i3, i5, 0);
                suggestedMinimumWidth = Math.max(suggestedMinimumWidth, paddingLeft + paddingRight + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                suggestedMinimumHeight = Math.max(i82, paddingTop + paddingBottom + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                i6 = View.combineMeasuredStates(i6, view.getMeasuredState());
            }
        }
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.isNestedScrollAccepted()) {
                    ...
                    if (behavior != null) {
                        ...
                        i4 = i > 0 ? Math.max(i7, this.mTempIntPair[0]) : Math.min(i7, this.mTempIntPair[0]);
                        i5 = i2 > 0 ? Math.max(i3, this.mTempIntPair[1]) : Math.min(i3, this.mTempIntPair[1]);
                        z = true;
                    }
                } else {
                    i4 = i7;
