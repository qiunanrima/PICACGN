...
@ViewPager.DecorView
/* loaded from: picacg_1.jar:android/support/design/widget/TabLayout.class */
public class TabLayout extends HorizontalScrollView {
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$AdapterChangeListener.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$Mode.class */
    public @interface Mode {
    }

    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$OnTabSelectedListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$PagerAdapterObserver.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$SlidingTabStrip.class */
    public class SlidingTabStrip extends LinearLayout {
            ...
            if (childAt == null || childAt.getWidth() <= 0) {
                ...
                if (this.mSelectionOffset > 0.0f) {
                    ...
                    if (this.mSelectedPosition < getChildCount() - 1) {
                        ...
                        i = (int) ((this.mSelectionOffset * childAt2.getLeft()) + ((1.0f - this.mSelectionOffset) * left));
                        i2 = (int) ((this.mSelectionOffset * childAt2.getRight()) + ((1.0f - this.mSelectionOffset) * right));
                    }
                }
            }
        ...
        void animateIndicatorToPosition(final int i, int i2) {
            ...
            if (Math.abs(i - this.mSelectedPosition) <= 1) {
                ...
                i3 = i < this.mSelectedPosition ? z ? left - dpToPx : dpToPx + right : z ? dpToPx + right : left - dpToPx;
                i4 = i3;
            }
            if (i3 == left && i4 == right) {
                return;
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$Tab.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$TabGravity.class */
    public @interface TabGravity {
    }

    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$TabLayoutOnPageChangeListener.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$TabView.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/TabLayout$ViewPagerOnTabSelectedListener.class */
    ...
    public Tab getTabAt(int i) {
        return (i < 0 || i >= getTabCount()) ? null : this.mTabs.get(i);
    }
