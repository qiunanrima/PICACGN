...
/* loaded from: picacg_1.jar:android/support/design/widget/CollapsingToolbarLayout.class */
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CollapsingToolbarLayout$LayoutParams.class */
    ...
    /* loaded from: picacg_1.jar:android/support/design/widget/CollapsingToolbarLayout$OffsetUpdateListener.class */
    ...
    private boolean isToolbarChild(View view) {
        boolean z = false;
        if (this.mToolbarDirectChild == null || this.mToolbarDirectChild == this ? view == this.mToolbar : view == this.mToolbarDirectChild) {
            z = true;
        }
        return z;
    }
    ...
    protected void drawableStateChanged() {
        ...
        if (this.mCollapsingTextHelper != null) {
            z3 = z2 | this.mCollapsingTextHelper.setState(drawableState);
        }
        if (z3) {
            invalidate();
        }
