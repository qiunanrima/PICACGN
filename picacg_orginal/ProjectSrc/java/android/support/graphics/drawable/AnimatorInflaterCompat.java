...
/* loaded from: picacg_1.jar:android/support/graphics/drawable/AnimatorInflaterCompat.class */
public class AnimatorInflaterCompat {
    ...
    /* loaded from: picacg_1.jar:android/support/graphics/drawable/AnimatorInflaterCompat$PathDataEvaluator.class */
            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        if (loadValues != null && objectAnimator2 != null && (objectAnimator2 instanceof ValueAnimator)) {
    ...
    */
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (z) {
            ...
            ofFloat = i2 == 0 ? Keyframe.ofFloat(namedFloat) : Keyframe.ofInt(namedFloat);
        }
        ...
        while (true) {
            ...
            if (i4 < arrayList.size()) {
                ...
                if (f5 > ((Float) arrayList.get(i4)).floatValue()) {
                    f4 = f5 - ((Float) arrayList.get(i4)).floatValue();
