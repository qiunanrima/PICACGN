...
/* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat.class */
public class NotificationCompat extends android.support.v4.app.NotificationCompat {

    @RequiresApi(24)
    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$Api24Extender.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$Builder.class */
        ...
        public CharSequence resolveText() {
            if (this.mStyle instanceof NotificationCompat.MessagingStyle) {
                ...
                if (findLatestIncomingMessage != null) {
                    return conversationTitle != null ? NotificationCompat.makeMessageLine(this, messagingStyle, findLatestIncomingMessage) : findLatestIncomingMessage.getText();
                }
            }
            ...
            if (this.mStyle instanceof NotificationCompat.MessagingStyle) {
                ...
                if (conversationTitle != null || findLatestIncomingMessage != null) {
                    if (conversationTitle == null) {
                        conversationTitle = findLatestIncomingMessage.getSender();
                    }
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$DecoratedCustomViewStyle.class */
    public static class DecoratedCustomViewStyle extends NotificationCompat.Style {
    }

    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$DecoratedMediaCustomViewStyle.class */
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
    }

    @RequiresApi(14)
    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$IceCreamSandwichExtender.class */
    ...
    @RequiresApi(16)
    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$JellybeanExtender.class */
    ...
    @RequiresApi(21)
    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$LollipopExtender.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/NotificationCompat$MediaStyle.class */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x007a, code lost:
        if (r19.getBigContentView() != null) goto L32;
     */
    ...
    */
    public static android.widget.RemoteViews addStyleGetContentViewLollipop(android.support.v4.app.NotificationBuilderWithBuilderAccessor r18, android.support.v4.app.NotificationCompat.Builder r19) {
        /*
            Method dump skipped, instructions count: 254
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.app.NotificationCompat.addStyleGetContentViewLollipop(android.support.v4.app.NotificationBuilderWithBuilderAccessor, android.support.v4.app.NotificationCompat$Builder):android.widget.RemoteViews");
    }
