...
/* loaded from: picacg_1.jar:android/support/v7/app/AppCompatDelegate.class */
public abstract class AppCompatDelegate {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/AppCompatDelegate$NightMode.class */
    ...
    private static AppCompatDelegate create(Context context, Window window, AppCompatCallback appCompatCallback) {
        return BuildCompat.isAtLeastO() ? new AppCompatDelegateImplO(context, window, appCompatCallback) : Build.VERSION.SDK_INT >= 24 ? new AppCompatDelegateImplN(context, window, appCompatCallback) : Build.VERSION.SDK_INT >= 23 ? new AppCompatDelegateImplV23(context, window, appCompatCallback) : Build.VERSION.SDK_INT >= 14 ? new AppCompatDelegateImplV14(context, window, appCompatCallback) : Build.VERSION.SDK_INT >= 11 ? new AppCompatDelegateImplV11(context, window, appCompatCallback) : new AppCompatDelegateImplV9(context, window, appCompatCallback);
    }
