...
/* loaded from: picacg_1.jar:android/support/v7/app/AlertController.class */
public class AlertController {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/AlertController$AlertParams.class */
    public static class AlertParams {
        ...
        /* loaded from: picacg_1.jar:android/support/v7/app/AlertController$AlertParams$OnPrepareListViewListener.class */
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                simpleCursorAdapter = this.mCursor == null ? new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/AlertController$ButtonHandler.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/AlertController$CheckedItemAdapter.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/AlertController$RecycleListView.class */
        ...
        if (this.mMessage != null) {
            ...
            this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() { // from class: android.support.v7.app.AlertController.2
                ...
                public void onScrollChange(NestedScrollView nestedScrollView, int i3, int i4, int i5, int i6) {
                    AlertController.manageScrollIndicators(nestedScrollView, view3, view4);
                }
            });
            ...
            this.mScrollView.post(new Runnable() { // from class: android.support.v7.app.AlertController.3
                ...
                public void run() {
                    AlertController.manageScrollIndicators(AlertController.this.mScrollView, view5, view6);
                }
            });
            ...
            this.mListView.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: android.support.v7.app.AlertController.4
                ...
                public void onScroll(AbsListView absListView, int i3, int i4, int i5) {
                    AlertController.manageScrollIndicators(absListView, view7, view8);
                }
            ...
            this.mListView.post(new Runnable() { // from class: android.support.v7.app.AlertController.5
                @Override // java.lang.Runnable
                public void run() {
                    AlertController.manageScrollIndicators(AlertController.this.mListView, view9, view10);
                }
            });
        }
    }
