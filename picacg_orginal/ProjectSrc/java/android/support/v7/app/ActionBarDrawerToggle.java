...
/* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle.class */
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle$Delegate.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle$DelegateProvider.class */
    public interface DelegateProvider {
        @Nullable
        Delegate getDrawerToggleDelegate();
    }

    /* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle$DummyDelegate.class */
    ...
    @RequiresApi(11)
    /* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle$HoneycombDelegate.class */
    ...
    @RequiresApi(14)
    /* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle$IcsDelegate.class */
    ...
    @RequiresApi(18)
    /* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle$JellybeanMr2Delegate.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/ActionBarDrawerToggle$ToolbarCompatDelegate.class */
