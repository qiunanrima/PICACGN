...
/* loaded from: picacg_1.jar:android/support/v7/app/AppCompatViewInflater.class */
public class AppCompatViewInflater {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/app/AppCompatViewInflater$DeclaredOnClickListener.class */
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            if (-1 != str2.indexOf(46)) {
                View createView = createView(context, str2, null);
                this.mConstructorArgs[0] = null;
                this.mConstructorArgs[1] = null;
                return createView;
            }
            for (int i = 0; i < sClassPrefixList.length; i++) {
                View createView2 = createView(context, str2, sClassPrefixList[i]);
                if (createView2 != null) {
                    this.mConstructorArgs[0] = null;
                    this.mConstructorArgs[1] = null;
                    return createView2;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x006c, code lost:
        if (((android.support.v7.view.ContextThemeWrapper) r6).getThemeResId() != r11) goto L17;
     */
    /*
    ...
    */
    private static android.content.Context themifyContext(android.content.Context r6, android.util.AttributeSet r7, boolean r8, boolean r9) {
        /*
            r0 = r6
            r1 = r7
            int[] r2 = android.support.v7.appcompat.R.styleable.View
            r3 = 0
            r4 = 0
            ...
            if (r0 == 0) goto L1c
            r0 = r7
            int r1 = android.support.v7.appcompat.R.styleable.View_android_theme
            r2 = 0
        ...
        L1f:
            ...
            if (r0 != 0) goto L4f
            r0 = r7
            int r1 = android.support.v7.appcompat.R.styleable.View_theme
            r2 = 0
            int r0 = r0.getResourceId(r1, r2)
            r10 = r0
            r0 = r10
