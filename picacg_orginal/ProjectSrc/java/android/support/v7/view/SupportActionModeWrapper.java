...
/* loaded from: picacg_1.jar:android/support/v7/view/SupportActionModeWrapper.class */
public class SupportActionModeWrapper extends android.view.ActionMode {
    final Context mContext;
    final ActionMode mWrappedObject;

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: picacg_1.jar:android/support/v7/view/SupportActionModeWrapper$CallbackWrapper.class */
