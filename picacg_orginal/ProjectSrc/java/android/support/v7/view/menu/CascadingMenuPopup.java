...
/* loaded from: picacg_1.jar:android/support/v7/view/menu/CascadingMenuPopup.class */
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/view/menu/CascadingMenuPopup$HorizPosition.class */
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (view != null) {
            ...
            createPopupWindow.setHorizontalOffset((this.mDropDownGravity & 5) == 5 ? z ? i + measureIndividualMenuWidth : i - view.getWidth() : z ? i + view.getWidth() : i - measureIndividualMenuWidth);
