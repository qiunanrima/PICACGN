...
/* loaded from: picacg_1.jar:android/support/v7/widget/LinearLayoutManager.class */
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider, ItemTouchHelper.ViewDropHandler {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/LinearLayoutManager$AnchorInfo.class */
        ...
        public void assignFromViewAndKeepVisibleRect(View view) {
            ...
            if (this.mLayoutFromEnd) {
                ...
                if (endAfterPadding > 0) {
                    ...
                    int min = (i - decoratedMeasurement) - (startAfterPadding + Math.min(LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(view) - startAfterPadding, 0));
                    if (min < 0) {
            ...
            if (startAfterPadding2 > 0) {
                int decoratedMeasurement2 = LinearLayoutManager.this.mOrientationHelper.getDecoratedMeasurement(view);
                int endAfterPadding2 = (LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - Math.min(0, (LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - totalSpaceChange) - LinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(view))) - (decoratedStart + decoratedMeasurement2);
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/LinearLayoutManager$LayoutChunkResult.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v7/widget/LinearLayoutManager$LayoutState.class */
    public static class LayoutState {
        ...
        public View nextViewInLimitedList(View view) {
            ...
            while (true) {
                ...
                view2 = this.mScrapList.get(i2).itemView;
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/LinearLayoutManager$SavedState.class */
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
            ...
            if (this.mPendingScrollPosition != -1) {
                ...
                if (this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
                    ...
                    if (findViewByPosition != null) {
                        ...
                        if (decoratedStart > 0) {
                            i5 = startAfterPadding + decoratedStart;
                            i6 = endPadding;
                        } else {
                            i6 = endPadding - decoratedStart;
                            i5 = startAfterPadding;
                        }
                    }
                }
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            if (this.mLayoutState.mAvailable > 0) {
                i9 = i6 + this.mLayoutState.mAvailable;
            }
            updateLayoutStateToFillEnd(this.mAnchorInfo);
            this.mLayoutState.mExtra = i9;
            this.mLayoutState.mCurrentPosition += this.mLayoutState.mItemDirection;
            fill(recycler, this.mLayoutState, state, false);
            int i10 = this.mLayoutState.mOffset;
            i2 = i7;
            i3 = i10;
            if (this.mLayoutState.mAvailable > 0) {
            ...
            fill(recycler, this.mLayoutState, state, false);
            int i12 = this.mLayoutState.mOffset;
            int i13 = this.mLayoutState.mCurrentPosition;
            int i14 = i5;
            if (this.mLayoutState.mAvailable > 0) {
                i14 = i5 + this.mLayoutState.mAvailable;
            }
            updateLayoutStateToFillStart(this.mAnchorInfo);
            this.mLayoutState.mExtra = i14;
            this.mLayoutState.mCurrentPosition += this.mLayoutState.mItemDirection;
            fill(recycler, this.mLayoutState, state, false);
            int i15 = this.mLayoutState.mOffset;
            i2 = i15;
            i3 = i12;
            if (this.mLayoutState.mAvailable > 0) {
        ...
        if (getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
                ...
                int i19 = i2 + fixLayoutEndGap;
                int fixLayoutStartGap = fixLayoutStartGap(i19, recycler, state, false);
                i17 = i19 + fixLayoutStartGap;
                i18 = i3 + fixLayoutEndGap + fixLayoutStartGap;
            } else {
                int fixLayoutStartGap2 = fixLayoutStartGap(i2, recycler, state, true);
                int i20 = i3 + fixLayoutStartGap2;
                int fixLayoutEndGap2 = fixLayoutEndGap(i20, recycler, state, false);
                i17 = i2 + fixLayoutStartGap2 + fixLayoutEndGap2;
                i18 = i20 + fixLayoutEndGap2;
            }
        }
