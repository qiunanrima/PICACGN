...
/* loaded from: picacg_1.jar:android/support/v7/widget/PositionMap.class */
class PositionMap<E> implements Cloneable {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/PositionMap$ContainerHelpers.class */
    ...
    /* renamed from: clone */
    public PositionMap<E> m233clone() {
    ...
    public void put(int i, E e) {
        ...
        if (this.mSize - i3 != 0) {
            int i4 = i3 + 1;
            System.arraycopy(this.mKeys, i3, this.mKeys, i4, this.mSize - i3);
            System.arraycopy(this.mValues, i3, this.mValues, i4, this.mSize - i3);
        }
        this.mKeys[i3] = i;
        this.mValues[i3] = e;
        this.mSize++;
