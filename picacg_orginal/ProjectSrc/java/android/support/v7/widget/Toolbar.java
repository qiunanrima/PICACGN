...
/* loaded from: picacg_1.jar:android/support/v7/widget/Toolbar.class */
public class Toolbar extends ViewGroup {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/Toolbar$LayoutParams.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/Toolbar$OnMenuItemClickListener.class */
    public interface OnMenuItemClickListener {
        boolean onMenuItemClick(MenuItem menuItem);
    }

    /* loaded from: picacg_1.jar:android/support/v7/widget/Toolbar$SavedState.class */
    ...
    public int getCurrentContentInsetEnd() {
        ...
        return this.mMenuView != null && (peekMenu = this.mMenuView.peekMenu()) != null && peekMenu.hasVisibleItems() ? Math.max(getContentInsetEnd(), Math.max(this.mContentInsetEndWithActions, 0)) : getContentInsetEnd();
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:123:0x054a A[LOOP:0: B:121:0x0544->B:123:0x054a, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:127:0x057f A[LOOP:1: B:125:0x0579->B:127:0x057f, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:131:0x05d2  */
    /* JADX WARN: Removed duplicated region for block: B:138:0x05f8 A[LOOP:2: B:136:0x05f2->B:138:0x05f8, LOOP_END] */
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            ...
            i11 = Math.max(i4, this.mCollapseButtonView.getMeasuredHeight() + getVerticalMargins(this.mCollapseButtonView));
            i12 = View.combineMeasuredStates(i5, this.mCollapseButtonView.getMeasuredState());
        }
        int currentContentInsetStart = getCurrentContentInsetStart();
        int max = Math.max(currentContentInsetStart, i10) + 0;
        iArr[objArr == 1 ? 1 : 0] = Math.max(0, currentContentInsetStart - i10);
        ...
        iArr[objArr2 == 1 ? 1 : 0] = Math.max(0, currentContentInsetEnd - i6);
        int i13 = max2;
        int i14 = i11;
        int i15 = i12;
        if (shouldLayout(this.mExpandedActionView)) {
            i13 = max2 + measureChildCollapseMargins(this.mExpandedActionView, i, max2, i2, 0, iArr);
            i14 = Math.max(i11, this.mExpandedActionView.getMeasuredHeight() + getVerticalMargins(this.mExpandedActionView));
            i15 = View.combineMeasuredStates(i12, this.mExpandedActionView.getMeasuredState());
        }
        int i16 = i13;
        int i17 = i14;
        int i18 = i15;
        if (shouldLayout(this.mLogoView)) {
            i16 = i13 + measureChildCollapseMargins(this.mLogoView, i, i13, i2, 0, iArr);
            i17 = Math.max(i14, this.mLogoView.getMeasuredHeight() + getVerticalMargins(this.mLogoView));
            i18 = View.combineMeasuredStates(i15, this.mLogoView.getMeasuredState());
        }
        int childCount = getChildCount();
        int i19 = i16;
        int i20 = 0;
        while (true) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0) {
                if (shouldLayout(childAt)) {
                    i21 = i19 + measureChildCollapseMargins(childAt, i, i19, i2, 0, iArr);
                    i17 = Math.max(i7, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
                    i22 = View.combineMeasuredStates(i18, childAt.getMeasuredState());
                } else {
                    i21 = i19;
                    i22 = i18;
                    i17 = i7;
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i, i19 + i24, i2, i23, iArr);
            ...
            i18 = View.combineMeasuredStates(i18, this.mTitleTextView.getMeasuredState());
            i9 = measuredHeight + verticalMargins;
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i8 = Math.max(i8, measureChildCollapseMargins(this.mSubtitleTextView, i, i19 + i24, i2, i9 + i23, iArr));
        ...
        int max3 = Math.max(i7, i9);
        int paddingLeft = getPaddingLeft();
        int paddingRight = getPaddingRight();
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        int resolveSizeAndState = View.resolveSizeAndState(Math.max(i19 + i8 + paddingLeft + paddingRight, getSuggestedMinimumWidth()), i, (-16777216) & i18);
        int resolveSizeAndState2 = View.resolveSizeAndState(Math.max(max3 + paddingTop + paddingBottom, getSuggestedMinimumHeight()), i2, i18 << 16);
        if (shouldCollapse()) {
