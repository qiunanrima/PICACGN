...
/* loaded from: picacg_1.jar:android/support/v7/widget/SearchView.class */
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/SearchView$AutoCompleteTextViewReflector.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/SearchView$OnCloseListener.class */
    public interface OnCloseListener {
        boolean onClose();
    }

    /* loaded from: picacg_1.jar:android/support/v7/widget/SearchView$OnQueryTextListener.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/SearchView$OnSuggestionListener.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/SearchView$SavedState.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/SearchView$SearchAutoComplete.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/widget/SearchView$UpdatableTouchDelegate.class */
    ...
    private void updateViewsVisibility(boolean z) {
        ...
        if (this.mCollapsedIcon.getDrawable() != null) {
            i2 = this.mIconifiedByDefault ? 8 : 0;
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            min = this.mMaxWidth > 0 ? Math.min(this.mMaxWidth, size) : Math.min(getPreferredWidth(), size);
        } else if (mode == 0) {
            min = this.mMaxWidth > 0 ? this.mMaxWidth : getPreferredWidth();
        } else if (mode != 1073741824) {
            min = size;
        } else {
            min = size;
            if (this.mMaxWidth > 0) {
                min = Math.min(this.mMaxWidth, size);
            }
        }
