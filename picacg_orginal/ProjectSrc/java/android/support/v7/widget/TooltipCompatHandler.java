...
/* loaded from: picacg_1.jar:android/support/v7/widget/TooltipCompatHandler.class */
class TooltipCompatHandler implements View.OnAttachStateChangeListener, View.OnHoverListener, View.OnLongClickListener {
    ...
    public void show(boolean z) {
        if (ViewCompat.isAttachedToWindow(this.mAnchor)) {
            ...
            long longPressTimeout = this.mFromTouch ? 2500L : (ViewCompat.getWindowSystemUiVisibility(this.mAnchor) & 1) == 1 ? HOVER_HIDE_TIMEOUT_SHORT_MS - ViewConfiguration.getLongPressTimeout() : HOVER_HIDE_TIMEOUT_MS - ViewConfiguration.getLongPressTimeout();
            this.mAnchor.removeCallbacks(this.mHideRunnable);
