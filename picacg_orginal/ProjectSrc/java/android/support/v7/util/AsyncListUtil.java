...
/* loaded from: picacg_1.jar:android/support/v7/util/AsyncListUtil.class */
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() { // from class: android.support.v7.util.AsyncListUtil.2
        ...
        private void requestTiles(int i, int i2, int i3, boolean z) {
            ...
            while (true) {
                ...
                AsyncListUtil.this.mBackgroundProxy.loadTile(z ? (i2 + i) - i5 : i5, i3);
                i4 = i5 + AsyncListUtil.this.mTileSize;
            }
        }
    ...
    /* loaded from: picacg_1.jar:android/support/v7/util/AsyncListUtil$DataCallback.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v7/util/AsyncListUtil$ViewCallback.class */
