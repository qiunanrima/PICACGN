...
/* loaded from: picacg_1.jar:android/support/transition/ChangeImageTransform.class */
public class ChangeImageTransform extends Transition {
    ...
    /* loaded from: picacg_1.jar:android/support/transition/ChangeImageTransform$3.class */
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (intrinsicWidth == 0 || intrinsicHeight == 0) {
            ...
            createNullAnimator = createMatrixAnimator(imageView, matrix3, matrix4);
        }
