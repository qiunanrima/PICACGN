...
/* loaded from: picacg_1.jar:android/support/transition/Transition.class */
public abstract class Transition implements Cloneable {
    ...
    /* loaded from: picacg_1.jar:android/support/transition/Transition$AnimationInfo.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: picacg_1.jar:android/support/transition/Transition$ArrayListManager.class */
    ...
    /* loaded from: picacg_1.jar:android/support/transition/Transition$EpicenterCallback.class */
    ...
    /* loaded from: picacg_1.jar:android/support/transition/Transition$MatchOrder.class */
    public @interface MatchOrder {
    }

    /* loaded from: picacg_1.jar:android/support/transition/Transition$TransitionListener.class */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: picacg_1.jar:android/support/transition/Transition$TransitionListenerAdapter.class */
    ...
    public void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        while (i2 < size) {
            ...
            if (transitionValues5 != null || transitionValues6 != null) {
                if (transitionValues5 == null || transitionValues6 == null || areValuesChanged(transitionValues5, transitionValues6)) {
                    ...
                    if (createAnimator != null) {
                        ...
                        if (createAnimator != null) {
                            ...
                            if (this.mPropagation != null) {
                                long startDelay = this.mPropagation.getStartDelay(viewGroup, this, transitionValues5, transitionValues6);
                                sparseIntArray.put(this.mAnimators.size(), (int) startDelay);
                                j = Math.min(startDelay, j2);
                            }
                            runningAnimators.put(createAnimator, new AnimationInfo(view, getName(), this, ViewUtils.getWindowId(viewGroup), transitionValues));
        ...
        if (j2 != 0) {
            for (int i6 = 0; i6 < sparseIntArray.size(); i6++) {
                Animator animator = this.mAnimators.get(sparseIntArray.keyAt(i6));
                animator.setStartDelay((sparseIntArray.valueAt(i6) - j2) + animator.getStartDelay());
            }
        }
    }
