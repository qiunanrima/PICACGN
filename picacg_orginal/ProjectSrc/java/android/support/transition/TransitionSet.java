...
/* loaded from: picacg_1.jar:android/support/transition/TransitionSet.class */
public class TransitionSet extends Transition {
    ...
    /* loaded from: picacg_1.jar:android/support/transition/TransitionSet$TransitionSetListener.class */
    ...
    public Transition mo53clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo53clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransition(this.mTransitions.get(i).mo53clone());
        }
