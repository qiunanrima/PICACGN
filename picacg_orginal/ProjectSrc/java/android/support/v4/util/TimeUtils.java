...
/* loaded from: picacg_1.jar:android/support/v4/util/TimeUtils.class */
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        if (i != 0) {
            ...
            int accumField5 = accumField4 + accumField(i8, 2, true, accumField4 > 0 ? 3 : 0) + 1;
            int i9 = 0;
            while (true) {
                i7 = i9;
                if (accumField5 >= i) {
        ...
        int i10 = i7 + 1;
        boolean z = i != 0;
        int printField = printField(cArr, i3, 'd', i10, false, 0);
        int printField2 = printField(cArr, i4, 'h', printField, printField != i10, z ? 2 : 0);
        int printField3 = printField(cArr, i5, 'm', printField2, printField2 != i10, z ? 2 : 0);
        int printField4 = printField(cArr, i6, 's', printField3, printField3 != i10, z ? 2 : 0);
