...
/* loaded from: picacg_1.jar:android/support/v4/app/FragmentManagerImpl.class */
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/app/FragmentManagerImpl$AnimateOnHWLayerIfNeededListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/app/FragmentManagerImpl$FragmentTag.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/app/FragmentManagerImpl$OpGenerator.class */
    public interface OpGenerator {
        boolean generateOps(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2);
    }

    /* loaded from: picacg_1.jar:android/support/v4/app/FragmentManagerImpl$PopBackStackState.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/app/FragmentManagerImpl$StartEnterTransitionListener.class */
            ...
            if (!arrayList.get(i2).mAllowOptimization) {
                ...
                if (arrayList2.get(i2).booleanValue()) {
                    while (true) {
                        ...
                        i5 = i6;
                        if (arrayList.get(i6).mAllowOptimization) {
                            break;
                        }
                        i6++;
                    }
            ...
            while (true) {
                ...
                if (valueAt != null) {
                    ...
                    if (valueAt.mLoaderManager != null) {
                        z3 = z | valueAt.mLoaderManager.hasRunningLoaders();
                    }
                }
                i++;
                z2 = z3;
                ...
                while (i3 < size2) {
                    ...
                    if (valueAt != null) {
                        ...
                        if (!valueAt.mIsNewlyAdded) {
                            ...
                            z7 = z6;
                            if (valueAt.mLoaderManager != null) {
                                z7 = z6 | valueAt.mLoaderManager.hasRunningLoaders();
                            }
                        }
                    }
                    i3++;
    ...
    */
    public void moveToState(final android.support.v4.app.Fragment r9, int r10, int r11, int r12, boolean r13) {
        /*
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if ("fragment".equals(str)) {
            ...
            if (Fragment.isSupportFragmentClass(this.mHost.getContext(), str2)) {
                ...
                if (fragment3 == null) {
                    fragment = this.mContainer.instantiate(context, str2, null);
