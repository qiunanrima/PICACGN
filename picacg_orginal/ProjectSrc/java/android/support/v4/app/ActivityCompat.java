...
/* loaded from: picacg_1.jar:android/support/v4/app/ActivityCompat.class */
public class ActivityCompat extends ContextCompat {

    /* loaded from: picacg_1.jar:android/support/v4/app/ActivityCompat$OnRequestPermissionsResultCallback.class */
    public interface OnRequestPermissionsResultCallback {
        void onRequestPermissionsResult(int i, @NonNull String[] strArr, @NonNull int[] iArr);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: picacg_1.jar:android/support/v4/app/ActivityCompat$RequestPermissionsRequestCodeValidator.class */
    public interface RequestPermissionsRequestCodeValidator {
        void validateRequestPermissionsRequestCode(int i);
    }

    @RequiresApi(21)
    /* loaded from: picacg_1.jar:android/support/v4/app/ActivityCompat$SharedElementCallback21Impl.class */
    ...
    @RequiresApi(23)
    /* loaded from: picacg_1.jar:android/support/v4/app/ActivityCompat$SharedElementCallback23Impl.class */
