...
/* loaded from: picacg_1.jar:android/support/v4/app/FragmentHostCallback.class */
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    public LoaderManagerImpl getLoaderManager(String str, boolean z, boolean z2) {
        ...
        LoaderManagerImpl loaderManagerImpl2 = (LoaderManagerImpl) this.mAllLoaderManagers.get(str);
        if (loaderManagerImpl2 == null && z2) {
