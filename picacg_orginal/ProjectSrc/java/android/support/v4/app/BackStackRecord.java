...
/* loaded from: picacg_1.jar:android/support/v4/app/BackStackRecord.class */
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/app/BackStackRecord$Op.class */
            ...
            switch (op.cmd) {
                ...
                case 6:
                    ...
                    if (op.fragment != fragment2) {
                        ...
                        this.mOps.add(i3, new Op(9, op.fragment));
                        i = i3 + 1;
                        fragment = null;
                        break;
                    }
                ...
                default:
                    ...
                    break;
                case 8:
                    this.mOps.add(i3, new Op(9, fragment2));
                    i = i3 + 1;
                ...
                if (i6 != i5) {
                    for (int i8 = i; i8 < i2; i8++) {
                        ...
                        for (int i9 = 0; i9 < size2; i9++) {
                            Op op2 = backStackRecord.mOps.get(i9);
