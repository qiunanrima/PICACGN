...
/* loaded from: picacg_1.jar:android/support/v4/media/AudioAttributesCompat.class */
public class AudioAttributesCompat {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/media/AudioAttributesCompat$AttributeContentType.class */
    public @interface AttributeContentType {
    }

    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: picacg_1.jar:android/support/v4/media/AudioAttributesCompat$AttributeUsage.class */
    public @interface AttributeUsage {
    }

    /* loaded from: picacg_1.jar:android/support/v4/media/AudioAttributesCompat$AudioManagerHidden.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/media/AudioAttributesCompat$Builder.class */
