...
/* loaded from: picacg_1.jar:android/support/v4/media/RatingCompat.class */
public final class RatingCompat implements Parcelable {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/media/RatingCompat$StarStyle.class */
    public @interface StarStyle {
    }

    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: picacg_1.jar:android/support/v4/media/RatingCompat$Style.class */
