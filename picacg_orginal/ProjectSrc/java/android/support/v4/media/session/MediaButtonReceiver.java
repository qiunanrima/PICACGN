...
/* loaded from: picacg_1.jar:android/support/v4/media/session/MediaButtonReceiver.class */
public class MediaButtonReceiver extends BroadcastReceiver {
    private static final String TAG = "MediaButtonReceiver";

    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaButtonReceiver$MediaButtonConnectionCallback.class */
