...
/* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat.class */
public class MediaSessionCompat {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$Callback.class */
    public static abstract class Callback {
        final Object mCallbackObj;
        WeakReference<MediaSessionImpl> mSessionImpl;

        @RequiresApi(21)
        /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$Callback$StubApi21.class */
        ...
        @RequiresApi(23)
        /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$Callback$StubApi23.class */
        ...
        @RequiresApi(24)
        /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$Callback$StubApi24.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImpl.class */
    ...
    @RequiresApi(18)
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi18.class */
    ...
    @RequiresApi(19)
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi19.class */
    ...
    @RequiresApi(21)
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi21.class */
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi21$ExtraSession.class */
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:14:0x0043 -> B:9:0x002c). Please submit an issue!!! */
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:13:0x003c -> B:9:0x002e). Please submit an issue!!! */
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:15:0x004c -> B:7:0x0026). Please submit an issue!!! */
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase.class */
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase$Command.class */
        ...
        /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase$MediaSessionStub.class */
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase$MessageHandler.class */
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:11:0x002f -> B:7:0x0021). Please submit an issue!!! */
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:11:0x0032 -> B:7:0x0024). Please submit an issue!!! */
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:11:0x0035 -> B:7:0x0020). Please submit an issue!!! */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$OnActiveChangeListener.class */
    public interface OnActiveChangeListener {
        void onActiveChanged();
    }

    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$QueueItem.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$SessionFlags.class */
    public @interface SessionFlags {
    }

    /* loaded from: picacg_1.jar:android/support/v4/media/session/MediaSessionCompat$Token.class */
