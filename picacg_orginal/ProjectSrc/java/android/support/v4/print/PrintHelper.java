...
/* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper.class */
public final class PrintHelper {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$OnPrintFinishCallback.class */
    public interface OnPrintFinishCallback {
        void onFinish();
    }

    @RequiresApi(20)
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$PrintHelperApi20Impl.class */
    ...
    @RequiresApi(23)
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$PrintHelperApi23Impl.class */
    ...
    @RequiresApi(24)
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$PrintHelperApi24Impl.class */
    ...
    @RequiresApi(19)
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$PrintHelperImpl.class */
    ...
    @RequiresApi(19)
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$PrintHelperKitkatImpl.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$PrintHelperStubImpl.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/print/PrintHelper$PrintHelperVersionImpl.class */
