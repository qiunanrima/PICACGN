...
/* loaded from: picacg_1.jar:android/support/v4/view/ViewPager.class */
public class ViewPager extends ViewGroup {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$DecorView.class */
    public @interface DecorView {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$ItemInfo.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$LayoutParams.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$MyAccessibilityDelegate.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$OnAdapterChangeListener.class */
    public interface OnAdapterChangeListener {
        void onAdapterChanged(@NonNull ViewPager viewPager, @Nullable PagerAdapter pagerAdapter, @Nullable PagerAdapter pagerAdapter2);
    }

    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$OnPageChangeListener.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$PageTransformer.class */
    public interface PageTransformer {
        void transformPage(View view, float f);
    }

    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$PagerObserver.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$SavedState.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$SimpleOnPageChangeListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: picacg_1.jar:android/support/v4/view/ViewPager$ViewPositionComparator.class */
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    if (i14 == 1) {
                        ...
                        max = paddingLeft;
                        i9 = childAt.getMeasuredWidth() + paddingLeft;
                    } else if (i14 != 5) {
                        max = paddingLeft;
                        i9 = paddingLeft;
                    } else {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    float f = (i5 - paddingLeft) - paddingRight;
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00a3, code lost:
        if (r12.position == r6.mCurItem) goto L28;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
