...
@ViewPager.DecorView
/* loaded from: picacg_1.jar:android/support/v4/view/PagerTitleStrip.class */
public class PagerTitleStrip extends ViewGroup {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/view/PagerTitleStrip$PageListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: picacg_1.jar:android/support/v4/view/PagerTitleStrip$SingleLineAllCapsTransform.class */
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        int i7 = ((width - i6) - ((int) (((width - (paddingLeft + i5)) - i6) * f3))) - i5;
        ...
        int max3 = Math.max((width - paddingRight) - measuredWidth3, i8 + this.mScaledTextSpacing);
