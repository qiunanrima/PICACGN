...
/* loaded from: picacg_1.jar:android/support/v4/graphics/PathParser.class */
public class PathParser {
    private static final String LOGTAG = "PathParser";

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: picacg_1.jar:android/support/v4/graphics/PathParser$ExtractFloatResult.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/graphics/PathParser$PathDataNode.class */
    public static class PathDataNode {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:68:0x05a3, code lost:
            if (r28 == 'T') goto L74;
         */
        /*
        ...
        */
        ...
        private static void arcToBezier(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            ...
            while (i < ceil) {
                ...
                double d23 = (d + ((d3 * cos) * cos3)) - (d12 * sin3);
                double d24 = d2 + (d3 * sin * cos3) + (d14 * sin3);
                double d25 = (d11 * sin3) - (d12 * cos3);
                double d26 = (sin3 * d13) + (cos3 * d14);
                double d27 = d22 - d21;
                double tan = Math.tan(d27 / 2.0d);
                double sin4 = (Math.sin(d27) * (Math.sqrt(((tan * 3.0d) * tan) + 4.0d) - 1.0d)) / 3.0d;
                path.rLineTo(0.0f, 0.0f);
                path.cubicTo((float) (d20 + (d18 * sin4)), (float) (d19 + (d17 * sin4)), (float) (d23 - (sin4 * d25)), (float) (d24 - (sin4 * d26)), (float) d23, (float) d24);
                i++;
                d19 = d24;
                d20 = d23;
                d21 = d22;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            double d23 = atan22;
            if (z2 != (atan22 >= 0.0d)) {
                d23 = atan22 > 0.0d ? atan22 - 6.283185307179586d : atan22 + 6.283185307179586d;
            }
            Double.isNaN(d5);
            double d24 = d * d5;
            Double.isNaN(d8);
            double d25 = d2 * d8;
            arcToBezier(path, (d24 * cos) - (d25 * sin), (d24 * sin) + (d25 * cos), d5, d8, d3, d4, radians, atan2, d23);
        }
