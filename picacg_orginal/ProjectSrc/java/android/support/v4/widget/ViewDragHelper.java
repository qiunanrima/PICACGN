...
/* loaded from: picacg_1.jar:android/support/v4/widget/ViewDragHelper.class */
public class ViewDragHelper {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/widget/ViewDragHelper$Callback.class */
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        int abs = Math.abs(i2);
        return Math.min(abs > 0 ? Math.round(Math.abs((f + (distanceInfluenceForSnapDuration * f)) / abs) * 1000.0f) * 4 : (int) (((Math.abs(i) / i3) + 1.0f) * 256.0f), (int) MAX_SETTLE_DURATION);
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 5:
                ...
                if ((this.mTrackingEdges & i7) != 0) {
                    this.mCallback.onEdgeTouched(i7 & this.mTrackingEdges, pointerId3);
                    return;
                }
                return;
            case 6:
