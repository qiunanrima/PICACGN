...
/* loaded from: picacg_1.jar:android/support/v4/widget/MaterialProgressDrawable.class */
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/widget/MaterialProgressDrawable$ProgressDrawableSize.class */
    public @interface ProgressDrawableSize {
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: picacg_1.jar:android/support/v4/widget/MaterialProgressDrawable$Ring.class */
    public static class Ring {
        ...
        private void drawTriangle(Canvas canvas, float f, float f2, Rect rect) {
            if (this.mShowArrow) {
                ...
                this.mArrow.offset(f5 - (f3 * f4), (float) ((d2 * sin) + exactCenterY));
                this.mArrow.close();
    ...
    float getMinProgressArc(Ring ring) {
        ...
        double centerRadius = ring.getCenterRadius();
