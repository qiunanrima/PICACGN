...
/* loaded from: picacg_1.jar:android/support/v4/widget/SwipeRefreshLayout.class */
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/widget/SwipeRefreshLayout$OnChildScrollUpCallback.class */
    public interface OnChildScrollUpCallback {
        boolean canChildScrollUp(SwipeRefreshLayout swipeRefreshLayout, @Nullable View view);
    }

    /* loaded from: picacg_1.jar:android/support/v4/widget/SwipeRefreshLayout$OnRefreshListener.class */
    ...
    private void moveSpinner(float f) {
        ...
        int i2 = (int) ((f3 * min) + (f3 * f4 * DECELERATE_INTERPOLATION_FACTOR));
        ...
        this.mProgress.setProgressRotation((((max * 0.4f) - 0.25f) + (f4 * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);
