...
/* loaded from: picacg_1.jar:android/support/v4/provider/FontsContractCompat.class */
public class FontsContractCompat {
    ...
    /* loaded from: picacg_1.jar:android/support/v4/provider/FontsContractCompat$Columns.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/provider/FontsContractCompat$FontFamilyResult.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/provider/FontsContractCompat$FontInfo.class */
    ...
    /* loaded from: picacg_1.jar:android/support/v4/provider/FontsContractCompat$FontRequestCallback.class */
        ...
        for (FontInfo fontInfo : fontInfoArr) {
            if (fontInfo.getResultCode() == 0) {
                ...
                if (!hashMap.containsKey(uri)) {
                    try {
                        FileChannel channel = new FileInputStream((Build.VERSION.SDK_INT > 19 ? contentResolver.openFileDescriptor(uri, "r", cancellationSignal) : contentResolver.openFileDescriptor(uri, "r")).getFileDescriptor()).getChannel();
