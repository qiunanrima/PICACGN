...
/* loaded from: picacg_1.jar:butterknife/ButterKnife.class */
public final class ButterKnife {
    ...
    /* loaded from: picacg_1.jar:butterknife/ButterKnife$Action.class */
    public interface Action<T extends View> {
        @UiThread
        void apply(@NonNull T t, int i);
    }

    /* loaded from: picacg_1.jar:butterknife/ButterKnife$Setter.class */
    ...
    private static Constructor<? extends Unbinder> findBindingConstructorForClass(Class<?> cls) {
        ...
        try {
            Constructor<? extends Unbinder> constructor2 = Class.forName(name + "_ViewBinding").getConstructor(cls, View.class);
            findBindingConstructorForClass = constructor2;
            if (debug) {
